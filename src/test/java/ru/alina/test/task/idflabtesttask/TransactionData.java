...
public class TransactionData {
    ...
    public static Transaction TRANSACTION_2 = new Transaction(2L, 1111111111, 2222222222L, Currency.RUB, new BigDecimal("220000.00"), new BigDecimal("2200.00"), LimitCategory.PRODUCT, OffsetDateTime.of(2024, 1, 7, 10, 0, 0, 0, ZoneOffset.UTC), ZONE_OFFSET, true);
    public static Transaction TRANSACTION_4 = new Transaction(4L, 1111111111, 2222222222L, Currency.RUB, new BigDecimal("39900.00"), new BigDecimal("399.00"), LimitCategory.PRODUCT, OffsetDateTime.of(2024, 2, 1, 10, 0, 0, 0, ZoneOffset.UTC), ZONE_OFFSET, false);
    public static Transaction TRANSACTION_5 = new Transaction(5L, 1111111111, 2222222222L, Currency.RUB, new BigDecimal("200.00"), new BigDecimal("2.2"), LimitCategory.PRODUCT, OffsetDateTime.of(2024, 2, 12, 10, 0, 0, 0, ZoneOffset.UTC), ZONE_OFFSET, true);
